...
parser.add_argument("-H","--host",help="Host IP adress",default="localhost")
parser.add_argument("-P","--port",help="Port num",default="8080")
parser.add_argument("-R","--reload",help="Reload?",nargs='?',const="False",default="False")
...
if __name__ == "__main__":
    ...
    uvicorn.run("tankerman:app",host = args.host ,port=int(args.port) )
